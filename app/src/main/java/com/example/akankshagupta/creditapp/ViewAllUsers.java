        ...
        button3.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer1.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button4.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer2.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button5.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer3.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button6.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer4.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button7.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer5.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button8.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer6.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button9.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer7.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button10.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer8.append("Mobile No :" + res.getString(3) + "\n");
        ...
        button11.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        buffer9.append("Mobile No :" + res.getString(3) + "\n");
    ...
    public void showMessage(String title,String Message){
        ...
        builder.setPositiveButton("Transfer Credits", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent i1 = new Intent(getApplicationContext(), TransferredCredits.class);
                startActivity(i1);
